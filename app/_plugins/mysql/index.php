...
<style type="text/css">
	...
	.sqlresult{ width: 100%; min-height: 30px; padding: 5px; margin: 0 0 10px 0; overflow-x: auto; }
	...
	.result_table tr th{ margin: 0; padding: 0 10px; font-size: 14px;  }
	.result_table tr td{ margin: 0; padding: 0 10px; font-size: 12px;  }
...
<table class="tableLists">
	...
	<tr>
		...
		<td>
			...
			<a href="javascript:void(0)" onclick="insert('<?=$tb[$mainTabName]?>', '<?=implode(",", $fields)?>')">Insert</a>
...
<script type="text/javascript">
	...
	function insert(name, colnames){
		...
		var command = "INSERT INTO `"+name+"` SET "+colSql;
		$(".sqlcommand").val(command);
	}
